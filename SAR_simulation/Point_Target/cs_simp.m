...
% SAR characteristics
fc = 1e10;  % carrier frequency 10GHz
lambda = c / fc;    % wavelength

% target area
X0 = 500;    % target area in azimuth is within [-X0, X0]
Rc = 10000; % center of imaged area
R0 = 300;   % target area in range is within [Rc-R0, Rc+R0]
...
Tr = 1.33e-6;    % pulse duration
Br = 500e6; % chirp frequency modulation bandwidth
